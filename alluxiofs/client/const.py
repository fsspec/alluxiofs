...
ALLUXIO_PAGE_SIZE_DEFAULT_VALUE = "100KB"
...
FULL_PAGE_URL_FORMAT = "http://{worker_host}:{http_port}/v1/page/{page_index}?ufsFullPath={file_path}"
FULL_CHUNK_URL_FORMAT = "http://{worker_host}:{http_port}/v1/file/{path_id}?ufsFullPath={file_path}&chunkSize={chunk_size}"
PAGE_URL_FORMAT = (
    "http://{worker_host}:{http_port}/v1/file/{path_id}"
    "/page/{page_index}?offset={page_offset}&length={page_length}&ufsFullPath={file_path}"
)
WRITE_PAGE_URL_FORMAT = "http://{worker_host}:{http_port}/v1/page/{page_index}?ufsFullPath={file_path}"
WRITE_CHUNK_URL_FORMAT = "http://{worker_host}:{http_port}/v1/file/{path_id}?ufsFullPath={file_path}&chunkSize={chunk_size}"
