...
ALLUXIO_LOCAL_CACHE_EVICTION_HIGH_WATERMARK = 0.8
ALLUXIO_LOCAL_CACHE_EVICTION_LOW_WATERMARK = 0.7
ALLUXIO_LOCAL_CACHE_EVICTION_SCAN_INTERVAL_MINUTES = 2
ALLUXIO_LOCAL_CACHE_TTL_TIME_MINUTES = 2
