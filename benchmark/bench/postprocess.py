...
def parse_args():
    parser = argparse.ArgumentParser(description="Postprocess and clean up files for benchmark")
    parser.add_argument('--path', type=str, required=False, help="Path where files will be cleaned from in remote")
    parser.add_argument('--local_path', type=str, required=False, help="Path where files will be cleaned from in local")
